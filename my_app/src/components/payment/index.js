...
const Payment = () => {
    ...
    const handleMethod = (method) => {
        ...
        else document.getElementById("paymentbtn").textContent = "Donate"
    }
        ...
        <div className={style.wrapper}>
            ...
            <div className={style.sideBySide}>
                <div className={style.paymentMethod}>
                    ...
                    <div>
                        <h3 className={style.title}>Total Amount: {amount}</h3>
                    </div>
                </div>
            ...
            <button className={style.btn} id="paymentbtn" onClick={handlePayNow}>Donate</button>
        </div>
    )
}
